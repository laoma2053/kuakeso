...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      // 阴影效果
      boxShadow: {
        'card': '0 1px 2px rgba(26,26,26,0.04), 0 1px 4px rgba(232,232,232,0.8)',              // 卡片阴影（边框色派生）
        'card-hover': '0 4px 14px rgba(5,81,255,0.08), 0 1px 4px rgba(5,81,255,0.04)',          // 卡片悬停阴影（品牌蓝单源）
        'search': '0 4px 20px rgba(5,81,255,0.12), inset 0 1px 0 rgba(255,255,255,0.8)',       // 搜索框阴影（外扩散+内高光）
        'glow': '0 0 24px rgba(5,81,255,0.18)',                                                 // 品牌蓝发光
        'glow-accent': '0 0 24px rgba(139,92,246,0.18)',                                        // 强调紫发光
        'modal': '0 20px 60px rgba(26,26,26,0.12), 0 4px 16px rgba(26,26,26,0.06)',            // 浮层/弹窗深层阴影
      },
